                ...
                <section className="grid border rounded-[1.25rem] bg-darkBlue w-[20.4375rem] min-h-[26.25rem] md:w-[25rem] md:min-h-[26.125rem]">
                    ...
                    <form onSubmit={handleSubmit(formSubmitHandler)} className="flex flex-col" noValidate>
                        <div className="px-[1.5rem] pb-[1.5rem] md:px-[2rem] relative">
                            <input type="email" placeholder="Email address" className={`text-bm bg-darkBlue border-b ${errors.password ? "border-red" : "border-lightBlue"} placeholder:font-outfit placeholder:font-light placeholder:text-bm w-full md:w-[21rem]
                        h-[2.3125rem] pl-[1rem] placeholder:leading-[1.5] py-[0.25rem] pb-[1.12rem] caret-red text-white focus:outline-none focus:border-white`} {...register("email", {
